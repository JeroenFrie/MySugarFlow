...
def Matlab_Calc(amount_peoples,weight,carbs,eat_time):
    ...
    #data workage values
    workbook = ExcelReader(r"C:\Users\20202619\OneDrive - TU Eindhoven\Vakken\Digital Twin 2\Matlab EDES python\Data_glucose_Val.xlsx")
    workbook_b = ExcelReader(r"C:\Users\20202619\OneDrive - TU Eindhoven\Vakken\Digital Twin 2\Matlab EDES python\Data_insulin_Val.xlsx")
    ...
    with open(r"C:\Users\20202619\OneDrive - TU Eindhoven\Vakken\Digital Twin 2\Matlab EDES python\Data_Glu_Ins_pre.csv", 'w', newline='', encoding='utf-8') as csvfile:
    ...
    wb.save(filename = r"C:\Users\20202619\OneDrive - TU Eindhoven\Vakken\Digital Twin 2\Matlab EDES python\Data_Glu_Ins_pre.xlsx")
