...
img = Image.open(r"C:\Users\20202619\OneDrive - TU Eindhoven\Vakken\Digital Twin 2\Matlab EDES python\Final version logo.png")
...
if choice == 'Login':
    ...
    if login: 
        ...
        if bio == 'Base settings':
            ...
            annotated_text(("Welcome to sugar flow","#afa"))
        elif bio == 'Add food':
            ...
            st.write('You can contact us at pentabetes@gmail.com')
